...
function ThemesTab() {
    ...
    async function refreshLocalThemes() {
        ...
        const userThemes = themes.map(theme => ({
            fileName: theme.fileName, // Assuming theme.fileName exists and is correct
            name: theme.fileName, // Adjusted to include fileName in the object
            author: "Unknown", // Default value as author is not provided by getThemesList
            description: "No description available" // Default value as description is not provided by getThemesList
        }));
